<?php
	...
	*/
	...
	if (isset($_POST["btnSubmitSMS"])) {
		...
		echo 'API Response is HTTP code </span><span STYLE="color: orange; font-size: 10pt"><b>' . $returnedSMS[0] . '</b></span><span STYLE="color: white; font-size: 10pt"> and Response body is:</span><span STYLE="color: orange; font-size: 10pt"><br/>'.$returnedSMS[1];
		echo '</span><hr>';
	}
